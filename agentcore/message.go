...
const (
	// RoleSystem identifies system-level messages (prompts, instructions).
	RoleSystem Role = "system"
	// RoleUser identifies messages from the human user.
	RoleUser Role = "user"
	// RoleAssistant identifies messages generated by the AI assistant.
	RoleAssistant Role = "assistant"
	// RoleTool identifies messages containing tool call results.
	RoleTool Role = "tool"
)
...
const (
	// MessageTypeStandard is the default message type (empty string), sent directly to the provider.
	MessageTypeStandard MessageType = ""
	// MessageTypeCompactionSummary identifies messages containing compaction summaries.
	MessageTypeCompactionSummary MessageType = "compaction_summary"
	// MessageTypeBranchSummary identifies messages containing branch summaries.
	MessageTypeBranchSummary MessageType = "branch_summary"
	// MessageTypeCustom identifies custom message types that are converted before reaching the provider.
