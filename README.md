...
- **当前（v0.3.0）**：技术交底书分析、专利新颖性分析、法律案例比较、Invisible Handoff、Embed Manifest（任意目录启动）、证据账本/权限门控/计划模式/Guardian AI 审查等 9 个 Reasonix 扩展包、SQLite 知识库 + RRF 混合检索、YAML 规则引擎 + OA 解析 + 反套话引擎、五步工作法 + Multi-Hypothesis Judge
- **下季度**：记忆编译器策略学习增强、评估框架集成、Manifest 热加载
