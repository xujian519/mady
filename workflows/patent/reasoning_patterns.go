			...
			CheckRules: []CheckRule{
				{
					...
					PathElements: [][]string{
						{"最接近的现有技术", termClosestPriorArt},
						{termDistinguishingFeatures, termDiffFeatures},
						{termCommonKnowledge, "惯用技术手段", "常规设计", "本领域常规"},
						{termObvious, "无需创造性劳动", "非显而易见"},
					},
				...
				},
				{
					...
					CheckType:        CheckInventiveness,
					RequiredElements: []string{termCommonKnowledge},
					Domain:           domainInventiveness,
			...
			CheckRules: []CheckRule{
				{
					...
					Domain:      domainInventiveness,
					PathElements: [][]string{
						{"最接近的现有技术", termClosestPriorArt, "对比文件1"},
						{termDistinguishingFeatures, termDiffFeatures},
						{termTechHint, "组合动机", "结合动机", "结合启示"},
					},
			...
			CheckRules: []CheckRule{
				{
					...
					Domain:      domainInventiveness,
					PathElements: [][]string{
						{termTechHint, "teaching suggestion motivation"},
						{termObvious, "obvious", "显而易见性"},
						{termPersonSkilled, "所属领域技术人员", "person skilled in the art"},
					},
			...
			CheckRules: []CheckRule{
				{
					...
					Domain:      domainInventiveness,
					PathElements: [][]string{
						{"用途特征", termUseLimit, "use limitation", "用途"},
						{"产品本身", "产品结构", "产品组成", "产品工艺"},
						{termInventiveness, "非显而易见"},
					},
			...
			CheckRules: []CheckRule{
				{
					...
					PathElements: [][]string{
						...
						{termTechEffect, "有益效果", "效果"},
						{termInventiveness, "创造性的辅助判断"},
					},
					DependsOn:     []string{"INVENTIVENESS-THREE-STEP"},
			...
			CheckRules: []CheckRule{
				{
					...
					PathElements: [][]string{
						{termPriorArt, "prior art"},
						{"单独对比", "单独对比原则", "一一对比"},
						{"技术领域", "技术问题", termTechSolution, termTechEffect},
					},
				...
				},
				{
					...
					Message:          "四相同标准分析不完整",
					CheckType:        CheckNovelty,
					RequiredElements: []string{termTechSolution, termTechEffect},
					Domain:           domainNovelty,
		...
		},
		{
			...
			CheckRules: []CheckRule{
				...
				},
				{
					...
					Message:          "互联网公开分析不完整",
					CheckType:        CheckPublicAccess,
					RequiredElements: []string{termInternetDisclosure, "网络公开"},
					Domain:           domainNovelty,
		...
		},
		{
			...
			CheckRules: []CheckRule{
				...
				},
				{
					...
					Domain:      domainNovelty,
					PathElements: [][]string{
						{termPriority, termPriorityDate, "priority date"},
						{"申请日", termFilingDate},
						{termPriorArt, termPriorArtDoc},
					},
			...
			CheckRules: []CheckRule{
				{
					...
					Domain:      domainClaims,
					PathElements: [][]string{
						{termFunctionalLimit, "功能限定", "功能性特征", "functional limitation"},
						{"具体实施方式", "实施例"},
						{termProtectionScope, "解释范围"},
					},
			...
			CheckRules: []CheckRule{
				{
					...
					PathElements: [][]string{
						{"充分公开", "公开充分", termEnablement},
						{"能够实现", "可实施", "能够制造", termCanUse},
						{termTechSolution, termTechEffect},
					},
			...
			CheckRules: []CheckRule{
				{
					...
					PathElements: [][]string{
						{termTechSolution, "technical solution"},
						{termNaturalLaw, "自然法则"},
				...
				},
				{
					...
					CheckType:        CheckSubjectMatter,
					RequiredElements: []string{termSciDiscovery, termMentalActivity, "疾病诊断方法"},
					Domain:           domainExamination,
			...
			CheckRules: []CheckRule{
				{
					...
					PathElements: [][]string{
						{termAmendmentExceed, "超范围", "超出原范围", "超范围修改", "amendment beyond scope"},
				...
				},
				{
					...
					Domain:      domainAmendment,
					PathElements: [][]string{
						{termPriority, termPriorityDate, "优先权转让"},
						{"申请日", termFilingDate},
						{"转让", "transfer", "assign"},
					},
			...
			CheckRules: []CheckRule{
				{
					...
					Domain:      domainDesign,
					PathElements: [][]string{
						{termDesignPatent, "工业设计", "design", "industrial design"},
						{termOverallVisual, "视觉效果", "整体外观", "整体视觉", "overall visual effect"},
						{termProductCategory, "产品类别", "同类产品", "相近种类"},
						{"相同", "近似", "实质相同"},
					},
