...
func TestProjectRegistry_DuplicateRootPath(t *testing.T) {
	...
	r1 := ProjectRecord{ProjectID: "proj_001", Domain: "patent", Alias: "案件一", RootPath: tmpDir}
	r2 := ProjectRecord{ProjectID: "proj_002", Domain: "legal", Alias: "案件二", RootPath: tmpDir}
...
func TestProjectRegistry_PersistenceAcrossInstances(t *testing.T) {
	...
	rec := ProjectRecord{ProjectID: "proj_persist", Domain: "patent", Alias: "持久化测试", RootPath: tmpDir}
	...
	if loaded.Domain != "patent" {
		t.Errorf("Domain = %q, want %q", loaded.Domain, "patent")
	}
}
...
func TestProjectRegistry_Delete(t *testing.T) {
	...
	reg, _ := NewProjectRegistry(dir)
	rec := ProjectRecord{ProjectID: "proj_del", Domain: "patent", RootPath: tmpDir}
...
func TestProjectRegistry_List(t *testing.T) {
	...
	reg, _ := NewProjectRegistry(dir)
	reg.Register(context.Background(), ProjectRecord{ProjectID: "proj_a", Domain: "patent", RootPath: dir1})
	reg.Register(context.Background(), ProjectRecord{ProjectID: "proj_b", Domain: "legal", RootPath: dir2})
...
func TestProjectRegistry_Touch(t *testing.T) {
	...
	reg, _ := NewProjectRegistry(dir)
	reg.Register(context.Background(), ProjectRecord{ProjectID: "proj_touch", Domain: "patent", RootPath: tmpDir})
...
func TestProjectRegistry_RefreshStatus_Active(t *testing.T) {
	...
	reg, _ := NewProjectRegistry(dir)
	reg.Register(context.Background(), ProjectRecord{ProjectID: "proj_active", Domain: "patent", RootPath: tmpDir})
...
func TestProjectRegistry_SaveAndLoadMeta(t *testing.T) {
	...
	reg, _ := NewProjectRegistry(dir)
	rec := ProjectRecord{ProjectID: "proj_meta", Domain: "patent", RootPath: tmpDir}
	reg.Register(context.Background(), rec)
...
func TestProjectRegistry_MetaDoesNotExist(t *testing.T) {
	...
	reg, _ := NewProjectRegistry(dir)
	reg.Register(context.Background(), ProjectRecord{ProjectID: "proj_nometa", Domain: "patent", RootPath: t.TempDir()})
