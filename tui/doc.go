...
//
// The TUI module is organized into 7 layers: Layer 0 (core + layout) through
// Layer 5 (chat), plus Layer 7 (agentadapter). Layer 6 (tui/stdio, procedural
// rendering) existed historically and was removed — all rendering now goes
// through core.Component. See tui/LAYERS.md for the authoritative layer table.
...
//	  (23 event types). Depends on github.com/xujian519/mady/agentcore
//	  for integration with the Mady agent runtime framework.
//
// # Quick Start
//
...
// # Rendering Model
//
// The module has a single rendering model:
//   - TUI Engine (Layers 3–5): Elm-architecture, differential rendering
//     (cell-level frame diff), Component interface. Used by ChatApp.
//
// core.SpinnerStyle (animation frame data) lives in Layer 0 so the Loader
// component can share it without cross-dependencies.
package tui
